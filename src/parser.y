...
root
	: function_list { root = make_node<Root>(@$, $1); }
	;
...
function_call
	...
	| name TOK_LPAREN expression comma_expression TOK_RPAREN { printf("Applying one argument constructor run \n"); $$ = make_node<FunctionCall>(@$, $1); $$ -> args = $4; $$ -> args -> push_back($3); }
	;
