...
bool SimpleAssign::codegen(CompilationUnit * unit) {
	llvm::Value * toAssign = expr -> codegen(unit);
	unit -> builder.CreateStore(toAssign, namedValues[n]);
...
Value * CastExpression:: codegen(CompilationUnit* unit) {
